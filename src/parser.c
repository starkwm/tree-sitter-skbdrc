...
enum ts_symbol_identifiers {
  ...
  anon_sym_command = 12,
  anon_sym_hyper = 13,
  sym_modifier_operator = 14,
  sym_keysy_operator = 15,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_keysy_operator] = "keysy_operator",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_keysy_operator] = sym_keysy_operator,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 159:
      ...
      END_STATE();
    case 160:
      ACCEPT_TOKEN(sym_keysy_operator);
      END_STATE();
    case 161:
